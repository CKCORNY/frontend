...
<div>
    ...
    <div className="container">
      <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div className="col">
          ...
          <img src="t1.png" alt="Bootstrap" width="100%" height={225} />
            <div className="card-body">
              <p className="card-text">เสื้อยืดสีเท่าลายดำ </p>
  ...
  <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/>
        ...
        <div className="col">
          <div className="card shadow-sm">
          <img src="t2.png" alt="Bootstrap" width="100%" height={225} />
            <div className="card-body">
  ...
  <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/>
        ...
        <div className="col">
          <div className="card shadow-sm">
          <img src="t3.png" alt="Bootstrap" width="100%" height={225} />
            <div className="card-body">
              <p className="card-text">เสื้อยืดสีน้ำเงินลายดำขาว </p>
  ...
  <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/>
        ...
        <div className="col">
          <div className="card shadow-sm">
            <img src="t4.png" alt="Bootstrap" width="100%" height={225} />
            <div className="card-body">
              <p className="card-text">เสื้อยืดสีดำลายทองโลโก้สะท้อนแสง </p>
